# SPDX-FileCopyrightText: © 2023-2023 onscreenproton <onscreenproton@gmail.com>
...
Included in this file should be a complete configuration, stolen primarily from
[[https://github.com/tecosaur/emacs-config][here]]. Hopefully this file finds a place and is synced somewhere online in order to preserve this for myself.

* Setup
To load this file, we need to initialize Doom and generate =init.el=

#+begin_src shell :eval query
git clone --recursive-submodules git@github.com:onscreenproton/emacs-config.git ~/.config/doom
echo "(doom! :config literate)" > ~/.config/doom/init.el
git clone --depth 1 https://github.com/hlissner/doom-emacs ~/.emacs.d
~/.emacs.d/bin/doom install; ~/.config/doom/setup.sh
#+end_src
See
[[https://tecosaur.github.io/emacs-config/config.html#rudimentary-configuration][example config]]
...
instances, in a similar manner to *Rebuild mail index while using mu4e
...
Personal information is configured here.

#+begin_src emacs-lisp
(setq user-full-name "onsc")
#+end_src
...
#+call: confpkg("!Pkg org-caldav")

Useful for syncing with my Nextcloud CalDAV

#+begin_src emacs-lisp
(setq org-caldav-url "https://nextcloud.onscreenproton.us.to/remote.php/dav/calendars/OnscreenProton/"
      org-caldav-calendar-id "emacs"
      org-caldav-inbox "/home/onscreenproton/Documents/org/calendar.org"
...
Thankfully, all we need to do to make this happen is use
~org-latex-preview-auto-mode~.

Included is some other config from
[[https://hieuphay.com/doom-emacs-config][Hieuphay's config]]
...
+ Selection of a math font that fits better with displayed text.
